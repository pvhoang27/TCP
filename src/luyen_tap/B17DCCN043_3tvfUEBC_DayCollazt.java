 ...
 */
//[Mã câu hỏi (qCode): 3tvfUEBC].  Một chương trình server cho phép kết nối qua giao thức TCP tại cổng 2206 (thời gian giao tiếp tối đa cho mỗi yêu cầu là 5s).
 ...
 * @author hoang
 */
public class B17DCCN043_3tvfUEBC_DayCollazt {
    public static void main(String[] args) throws Exception{
        Socket socket = new Socket("203.162.10.109", 2206);
        OutputStream out = socket.getOutputStream();
        InputStream in = socket.getInputStream();
        
        String request = "B17DCCN043;3tvfUEBC";
        ...
        String a = "";
        while(true){
            // đâu tiên là cnt = 0 thì String a + số n vào thôi 
            if(cnt == 0 ) a = a + n;
            // lần thứ thì cnt > 0 thì sẽ auto là String + với số n mới 
            else a = a +" "+ n;
            cnt ++;
